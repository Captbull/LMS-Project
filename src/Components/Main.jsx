      ...
      <div className="w-full h-[100%] md:h-auto grid md:grid-cols-2">
        <div className="bg-white pt-8 md:pt-[2rem] ">
          <div className="text-3xl md:text-5xl leading-[4rem] uppercase font-bold p-10 md:p-[5rem]">
            <h1 className="text-white tracking-[5px] text-[black]">
              Microlearning{" "}
            </h1>
            <h1 className="text-white tracking-[5px] text-[black]">
              made easy
            </h1>
            <div className="text-sm md:text-lg font-normal text-2xl text-[black] md:text-[24px] leading-[150%] text-white mt-8 md:mt-[3rem]">
